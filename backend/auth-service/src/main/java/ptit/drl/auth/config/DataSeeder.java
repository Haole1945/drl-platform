...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (roleRepository.count() > 0) {
            System.out.println("[Auth Service] Database already seeded. Skipping...");
            return;
        }
        
        System.out.println("[Auth Service] Seeding initial data...");
        ...
        Permission permStudentEdit = new Permission("STUDENT:UPDATE_OWN", "Chỉnh sửa thông tin sinh viên của chính mình");
        ...
        Permission permEvaluationUpdateOwn = new Permission("EVALUATION:UPDATE_OWN", "Cập nhật đánh giá của chính mình");
        ...
        System.out.println("[Auth Service] ✓ Created " + permissionRepository.count() + " permissions");
        ...
        System.out.println("[Auth Service] ✓ Created STUDENT role");
        ...
        System.out.println("[Auth Service] ✓ Created CLASS_MONITOR role");
        ...
        System.out.println("[Auth Service] ✓ Created UNION_REPRESENTATIVE role");
        ...
        System.out.println("[Auth Service] ✓ Created ADVISOR role");
        ...
        System.out.println("[Auth Service] ✓ Created FACULTY_INSTRUCTOR role");
        ...
        System.out.println("[Auth Service] ✓ Created CTSV_STAFF role");
        ...
        System.out.println("[Auth Service] ✓ Created INSTITUTE_COUNCIL role");
        ...
        System.out.println("[Auth Service] ✓ Created INSTRUCTOR role");
        ...
        System.out.println("[Auth Service] ✓ Created ADMIN role");
        ...
        System.out.println("[Auth Service] ✓ Created admin user (username: admin, password: Admin123!)");
        ...
        System.out.println("[Auth Service] ✓ Created student user (username: student, password: Student123!)");
        ...
        System.out.println("[Auth Service] ✓ Created class monitor user (username: classmonitor, password: Monitor123!)");
        ...
        System.out.println("[Auth Service] ✓ Created union representative user (username: unionrep, password: Union123!)");
        ...
        System.out.println("[Auth Service] ✓ Created advisor user (username: advisor, password: Advisor123!)");
        ...
        System.out.println("[Auth Service] ✓ Created faculty instructor user (username: faculty, password: Faculty123!)");
        ...
        System.out.println("[Auth Service] ✓ Created CTSV staff user (username: ctsv, password: Ctsv123!)");
        ...
        System.out.println("[Auth Service] ✓ Created institute council user (username: council, password: Council123!)");
        ...
        System.out.println("[Auth Service] ✓ Created instructor user (username: instructor, password: Instructor123!)");
        
        System.out.println("[Auth Service] ✓ Seeding completed!");
        System.out.println("[Auth Service] ========================================");
        System.out.println("[Auth Service] Test Accounts Summary:");
        System.out.println("[Auth Service] 1. admin / Admin123! - ADMIN");
        System.out.println("[Auth Service] 2. student / Student123! - STUDENT (N21DCCN002)");
        System.out.println("[Auth Service] 3. classmonitor / Monitor123! - CLASS_MONITOR (N21DCCN001)");
        System.out.println("[Auth Service] 4. unionrep / Union123! - UNION_REPRESENTATIVE (N21DCCN050)");
        System.out.println("[Auth Service] 5. advisor / Advisor123! - ADVISOR");
        System.out.println("[Auth Service] 6. faculty / Faculty123! - FACULTY_INSTRUCTOR");
        System.out.println("[Auth Service] 7. ctsv / Ctsv123! - CTSV_STAFF");
        System.out.println("[Auth Service] 8. council / Council123! - INSTITUTE_COUNCIL");
        System.out.println("[Auth Service] 9. instructor / Instructor123! - INSTRUCTOR");
        System.out.println("[Auth Service] ========================================");
    }
}
