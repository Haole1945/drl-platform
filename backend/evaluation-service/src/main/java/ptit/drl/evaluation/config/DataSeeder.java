...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // 1.3 Ý thức chấp hành nội quy về các kỳ thi (4đ), 1.4 Tham gia ngoại khóa
        // (2đ), 1.5 Tinh thần vượt khó (1đ)
        ...
        // Theo spec: 2.1 Thực hiện nội quy (15đ), 2.2 Họp lớp/Sinh hoạt đoàn thể (5đ),
        // 2.3 Hội thảo việc làm (5đ)
        ...
        // Theo spec: 3.1 Hoạt động chính trị, văn nghệ, thể thao (10đ), 3.2 Công tác xã
        // hội (4đ),
        // 3.3 Tuyên truyền hình ảnh trường (3đ), 3.4 Phòng chống tệ nạn (3đ), 3.5 Đưa
        // thông tin sai lệch (-10đ)
        ...
        // Theo spec: 5.1 Lớp trưởng/bí thư (4đ), 5.2 Thành viên CLB, tham gia tổ chức
        // (3đ), 5.3 Thành tích đặc biệt (3đ)
